...
aid int unsigned not null auto\_increment,
...
key \(username\(12\)\) USING**BTREE**—_此处 uname 列只创建了最左12个字符长度的部分索引_

\)engine=InnoDB;

一个经典的**B+树索引数据结构**见下图：

![](http://img0.tuicool.com/2ayUzq2.jpg!web)
...
![](http://img1.tuicool.com/F7N3Ifi.jpg!web)
